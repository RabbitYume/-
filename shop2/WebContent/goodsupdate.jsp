	...
	<header class="header">
		<nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
			...
			<ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
				<li class="nav-item">
					<form id="select" method="post" action="GoodsSumServlet?op=select"
						...
						<div class="col-lg-12 mb-5">
							<div class="card">
								<div class="card-header">
									<h3 class="h6 text-uppercase mb-0">商品</h3>
								</div>
								<div class="card-body">
									<form method="post" action="GoodsSumServlet?op=update"
										class="form-horizontal">
										<div class="form-group row">
											<label class="col-md-3 form-control-label">商品编号</label>
											<div class="col-md-9">
												<input type="text" name="id" class="form-control" readonly="true" value="<%=id%>"><small
													class="form-text text-muted ml-3">商品编码=类别代码(1位)+品名代码(1位)+品牌代码(2位)+型号代码(2位)</small>
											</div>
										</div>
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">商品名称</label>
											<div class="col-md-9">
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">品牌</label>
											<div class="col-md-9">
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">型号</label>
											<div class="col-md-9">
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">销售单价</label>
											<div class="col-md-9">
										...
										<div class="form-group row">
											<div class="col-md-9 ml-auto">
												<a href="goodsindex.jsp" class="btn btn-secondary">取消</a> <input
