<%@page import="dao.impl.StockManagerImpl"%>
...
<%
	List<Stock> stocks = new StockManagerImpl().getStock();
	if (stocks == null) {
	...
	<header class="header">
		<nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
			...
			<ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
				<li class="nav-item">
					<form id="select" method="post" action="StockSumServlet?op=select"
						...
						<div class="">
							<div class="card">
								<div class="card-header">
									<h6 class="text-uppercase mb-0">入库记录</h6>
									<div align="right">
										<input class="btn btn-sm btn-primary" type="button" value="入库"
											onclick="window.location.href = 'stockinsert.jsp'">&nbsp;&nbsp;
										<input class="btn btn-sm btn-primary" type="button" value="退货"
											onclick="window.location.href = 'stockreturng.jsp'">
									</div>
								</div>
								<div class="card-body">
										...
										<table class="table table-striped card-text" cellspacing="20"
											...
											<tbody>
												...
												<tr>
													...
													<td><%=stock.getBuyprice()%></td>
													<td><%=stock.getStock()%></td>
													<td><a
														href="StockSumServlet?id=<%=stock.getId()%>&op=del"
														class="btn btn-sm btn-danger">删除</a></td>
													<td><a
														href="stockupdate.jsp?id=<%=stock.getId()%>&op=update"
														class="btn btn-sm btn-info">更新</a></td>
												</tr>
												<%
													}
												%>
