						...
						<div class="col-lg-12 mb-5">
							<div class="card">
								<div class="card-header">
									<h3 class="h6 text-uppercase mb-0">退货</h3>
								</div>
								<div class="card-body">
									<form method="post" action="StockSumServlet?op=returng"
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">退回数量</label>
											<div class="col-md-9">
										...
										<div class="form-group row">
											<div class="col-md-9 ml-auto">
												<a href="stockindex.jsp" class="btn btn-secondary">取消</a> <input
