<%@page import="dao.impl.SupplierManagerImpl"%>
...
<%
	List<Supplier> suppliers = new SupplierManagerImpl().getSupplier();
	if (suppliers == null) {
						...
						<div class="">
							<div class="card">
								<div class="card-header">
									<h6 class="text-uppercase mb-0">供货商管理</h6>
									<div align="right">
										<input class="btn btn-sm btn-primary" type="button" value="添加"
											onclick="window.location.href = 'supplierinsert.jsp'">
									</div>
								</div>
								<div class="card-body">
										...
										<table class="table table-striped card-text" cellspacing="20"
											...
											<tbody>
												...
												<tr>
													...
													<td><%=supplier.getS_address()%></td>
													<td><%=supplier.getS_phone()%></td>
													<td><a
														href="SupplierSumServlet?id=<%=supplier.getS_id()%>&op=del"
														class="btn btn-sm btn-danger">删除</a> <a
														href="supplierupdate.jsp?id=<%=supplier.getS_id()%>&op=update"
