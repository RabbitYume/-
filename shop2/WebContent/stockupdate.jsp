						...
						<div class="col-lg-12 mb-5">
							<div class="card">
								<div class="card-header">
									<h3 class="h6 text-uppercase mb-0">修改入库记录</h3>
								</div>
								<div class="card-body">
									<form method="post" action="StockSumServlet?op=update"
										class="form-horizontal">
										<div class="form-group row">
											<label class="col-md-3 form-control-label">编号</label>
											<div class="col-md-9">
												<input name="id" readonly="true" value="<%=id%>" type="text" class="form-control">
											</div>
										</div>
										<div class="line"></div>
										<div class="form-group row">
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">供货商编号</label>
											<div class="col-md-9">
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">入库日期</label>
											<div class="col-md-9">
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">进货数量</label>
											<div class="col-md-9">
										...
										<div class="line"></div>
										<div class="form-group row">
											<label class="col-md-3 form-control-label">进货价</label>
											<div class="col-md-9">
										...
										<div class="form-group row">
											<div class="col-md-9 ml-auto">
												<a href="stockindex.jsp" class="btn btn-secondary">取消</a>
