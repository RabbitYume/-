												...
												<c:forEach items="${requestScope.stocks}" var="stock">
													<tr>
														...
														<td><a href="javascript:void(0);"
															onclick="fun(${stock.id})" class="btn btn-sm btn-danger">删除</a></td>
														<td><a
															href="stockupdate.jsp?id=${stock.id}&op=update" class="btn btn-sm btn-info">更新</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
...
<script>
   	...
   	function fun(val){
   		var r=confirm("确认删除吗？");
   		if(r){
   			location.href="StockSumServlet?op=del&id="+val;
   		}
   	}
   </script>
</html>