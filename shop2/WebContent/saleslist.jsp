											...
											<tbody>
												<c:forEach items="${sales}" var="sale">
													<tr>
														...
														<td>${sale.ps_id}</td>
														<td>
														    <a href="javascript:void(0);" onclick="fun(${sale.danhao})" class="btn btn-sm btn-danger">删除</a>
														</td>
														<td>
														    <a href="salesupdate.jsp?id=${sale.danhao}&op=update" class="btn btn-sm btn-info">更新</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
...
<script>
   	...
   	function fun(val){
   		var r=confirm("确认删除吗？");
   		if(r){
   			location.href="SalesSumServlet?op=del&id="+val;
   		}
   	}
   	function exporExcel() {
