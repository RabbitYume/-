			...
			<ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
				<li class="nav-item">
					<form id="select" method="post"
						action="SupplierSumServlet?op=select"
						class="ml-auto d-none d-lg-block">
						<div class="form-group position-relative mb-0">
							<input id="getbyid" type="text" name="id" placeholder="请输入供货商编号"
							...
							<div class="col-lg-12 mb-5">
								<div class="card">
									<div class="card-header">
										<h3 class="h6 text-uppercase mb-0">修改供货商</h3>
									</div>
									<div class="card-body">
										<form method="post" action="SupplierSumServlet?op=update" class="form-horizontal">
											<div class="form-group row">
												<label class="col-md-3 form-control-label">供货商编号</label>
												<div class="col-md-9">
													<input type="text" name="id" readonly="true" value="<%=id%>" class="form-control">
												</div>
											</div>
											<div class="line"></div>
											<div class="form-group row">
												<label class="col-md-3 form-control-label">供货商名称</label>
												<div class="col-md-9">
											...
											<div class="line"></div>
											<div class="form-group row">
												<label class="col-md-3 form-control-label">所在地</label>
												<div class="col-md-9">
											...
											<div class="form-group row">
												<div class="col-md-9 ml-auto">
													<a href="supplierindex.jsp" class="btn btn-secondary">取消</a>
