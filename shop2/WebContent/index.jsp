...
<%
	List<People> peoples = new PeopleManagerImpl().getPeople();
	if (peoples == null) {
						...
						<div class="">
							<div class="card">
								<div class="card-header">
									<h6 class="text-uppercase mb-0">员工管理</h6>
									<div align="right">			
								...
								<div class="card-body">
									<form method="POST" id="form">
										<table class="table table-striped card-text" cellspacing="20" cellpadding="20">
											<thead>
												<tr>
													<th>编号</th>
													<th>姓名</th>
											...
											<tbody>
												...
												%>
												<tr>
													<td><%=people.getP_id()%></td>
													<td><%=people.getP_name()%></td>
													<td><%=people.getP_gender()%></td>
													<td><%=people.getP_wage()%></td>
													<td><%=people.getP_position()%></td>
													<td><%=people.getP_pwd()%></td>
													<td><%=people.getP_dang()%></td>
													<td><%=people.getP_resume()%></td>
													<td><%=people.getP_photo()%></td>
													<td><a
														href="PeopleSumServlet?id=<%=people.getP_id()%>&op=del"
														class="btn btn-sm btn-danger">删除</a></td>
													<td><a
														href="update.jsp?id=<%=people.getP_id()%>&op=update"
